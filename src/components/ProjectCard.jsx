    ...
    <>
      <div className=" border-mist-300 border w-70 md:w-85 flex flex-col items-center justify-between rounded-2xl bg-white rounded-t-2xl gap-3 ">
        <div className='h-[120px]'>
          <img src={img == 'tt' ? tt : img == 'ff' ? ff : img == 'nm' ? nm : img == 'sc' ? sc : ff} alt="tt" className=' cursor-pointer transition-transform ease-in-out w-full object-cover rounded-t-2xl' /></div>
        <div className='mt-2 bg-white rounded-xl flex flex-col gap-1 '>
          ...
          <p className='px-5 text-center text-sm'>{p} <span className='text-blue-500 cursor-pointer'>..more</span> </p>
