  ...
  return (
    ...
    <div className="flex mt-5 ">
      ...
      <div className="relative ">
        <img src={img == 'tt' ? tt : img == 'ff' ? ff : img == 'nm' ? nm : img == 'sc' ? sc : ff} alt="tt" className='  border-mist-300 gra border  transition-transform ease-in-out w-100 object-cover h-60 [corner-shape:squircle] rounded-4xl ' />
